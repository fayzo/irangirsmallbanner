...
if (isset($_GET['username']) == true && empty($_GET['username']) == false) {
    ...
    if (!isset($profileData['user_id'])) {
     ...
     if (isset($_SERVER['REQUEST_URI']) == '/car/property.index' ||
         isset($_SERVER['REQUEST_URI']) == '/car/property.view_all_property' ||
         isset($_SERVER['REQUEST_URI']) == '/car/property.property_request'
    ){
        # code...
